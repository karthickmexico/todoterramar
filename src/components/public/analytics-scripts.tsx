...
export function AnalyticsScripts({
  ...
  const resolvedGaId = gaId || process.env.NEXT_PUBLIC_GA_ID;
  const resolvedGtmId = gtmId;
  const resolvedPixelId = metaPixelId || process.env.NEXT_PUBLIC_META_PIXEL_ID;
  const resolvedTiktokId = tiktokPixelId;
...
fbq('track', 'PageView');`}
  ...
  ttq.load('${resolvedTiktokId}');ttq.page();
}(window, document, 'ttq');`}
        </Script>
      )}
    </>
